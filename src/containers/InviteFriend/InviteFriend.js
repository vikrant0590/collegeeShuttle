...
import { Container, Content, Header, Button, Left, Body, Title, Right, Row, Col } from 'native-base';
        ...
        <Header style={{backgroundColor:'#fc214f',borderBottomWidth:0}}>
          ...
          <Right>
            <Button transparent onPress={()=> Actions.pop()}>
              <Text style={{ color: Colors.white, fontSize: Fonts.size.medium, fontFamily: Fonts.lato.bold}}>
                Cancel
              </Text>
            </Button>
          </Right>
